...
var defaults = baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          (eq(value, objectProto$f[key]) && !hasOwnProperty$c.call(object, key))) {
...
var script$2 = {
    ...
    methods: {
      getPoint: function getPoint(index){
        ...
        // console.log('POUR LE LINK', extraProps);
        // console.log('la clef', ("link-" + (extraProps.attrs.id)));
    		return h(
          'g',
...
var script$3 = {
    name: "SVGWidget",
    components: {
      linkWidget: __vue_component__$2,
    },
    props: {
			engine: {
        required: true,
...
var __vue_render__$1 = function() {
  ...
  return _c(
    "svg",
    { staticClass: "storm-flow-canvas", style: _vm.styles },
    _vm._l(_vm.engine.state.links, function(link, index) {
      return _c("link-widget", {
        key: index,
        attrs: { engine: _vm.engine, link: link, "new-point": _vm.newPoint }
      })
    }),
    1
  )
...
var script$4 = {
    ...
    mixins: [setState],
    components: {
      nodeViewWidget: __vue_component__$1,
      svgWidget: __vue_component__$3,
    },
    props: {
			engine: {
        required: true,
...
var __vue_render__$2 = function() {
  ...
  return _c(
    ...
    [
      _c("svg-widget", {
        attrs: { engine: _vm.engine, "new-point": _vm.newPoint }
      }),
      _vm._v(" "),
      _c("node-view-widget", { attrs: { engine: _vm.engine } })
    ],
    1
  )
};
...
var script$6 = {
    ...
    components: {
      portWidget: __vue_component__$5,
    },
    props: {
      name: { default: 'Node' },
			node: {},
...
var __vue_render__$4 = function() {
  ...
  return _c(
    "div",
    { staticClass: "basic-node", style: { backgroundColor: _vm.color } },
    [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "ports" }, [
        _c(
          "div",
          { staticClass: "in" },
          [
            _vm._l(_vm.formattedInPorts, function(port) {
              return _c(
                "div",
                { key: port, staticClass: "in-port" },
                [
                  _c("port-widget", {
                    attrs: { name: _vm.getName(port), node: _vm.node }
                  }),
                  _vm._v(" "),
                  _c("div", { staticClass: "name" }, [
                    _vm._v(
                      "\n          " +
                        _vm._s(_vm.getDisplay(port)) +
                        "\n        "
                    )
                  ])
                ],
...
function Engine() {
	return {
      ...
      var validator$ = bypassValidation ? validatorNoop() : this.state.validators.onEdgeRemove(link);
      ...
      var validator$ = bypassValidation ? validatorNoop() : this.state.validators.onNodeRemove(node);
      validator$.then(function (valid) {
        if (valid) {
          //remove the links
...
var DEFAULT_TEMPLATE = ['default', __vue_component__$6, {}];
...
var script$7 = {
  ...
  components: {
    canvasWidget: __vue_component__$4,
  },
  created: function created() {
    var this$1 = this;
...
var __vue_render__$5 = function() {
  ...
  return _c(
    "div",
    { staticClass: "vue-flowchart" },
    [_c("canvas-widget", { attrs: { engine: _vm.engine } })],
    1
  )
};
...
export { __vue_component__$5 as portWidget };
//# sourceMappingURL=vueflowchart.esm.js.map
